<?php
/**
 * @version		$Id: item.php 1492 2015-02-22 17:40:09Z joomlaworks@gmail.com $
 * @package		K2
...
<div id="k2Container" class="itemBlogView itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="blog-item-meta">
		...
		<span class="itemAuthor">
			<strong><?php echo JText::_('K2_WRITTEN_BY'); ?></strong>

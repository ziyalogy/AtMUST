<?php
/**
 * @version		$Id: category.php 1527 2015-03-12 12:45:31Z lefteris.kavadas $
 * @package		K2
...
<div id="k2Container" class="itemListBlogView itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
